...
final class ProductDetailAPIMock: ProductDetailAPIProtocol {
    
    var shouldFail: Bool = false
    var failError: NetworkError = .noData
    
    func getProductDetail(with id: Int) async throws -> HatchworksCodeChallenge.ProductDetailResponse {
        if shouldFail {
        ...
        return ProductDetailResponse.mock
    }
}
